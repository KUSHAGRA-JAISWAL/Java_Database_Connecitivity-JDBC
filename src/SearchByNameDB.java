/* Program to search the records by name in localhost user created databse which is java and table name is jar. */
...
public class SearchByNameDB {
    public static void main(String args[]) {
        ...
        try {
            ...
            String query = "select * from jar where name='" + name + "'";
            // query for searching records by name.
