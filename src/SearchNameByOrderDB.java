/* Program to search the records by name and show records in order of localhost user created databse which is java and table name is jar. */
...
public class SearchNameByOrderDB {
    public static void main(String args[]) {
        ...
        try {
            ...
            String query = "select * from jar where name='" + name + "'order by sno"; // query for searching records by
                                                                                      // name in order.
